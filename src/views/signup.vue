<template>
  <div class="signup-page">
    ...
    <div class="signup-container">
      ...
      <p class="login-link">
        Already a reader? <router-link to="/login">Login here</router-link>
      </p>
    </div>
  </div>
...
.background {
  ...
  width: 100%;
  height: 100%;
  background: url('@/assets/READiculous-background.jpeg') no-repeat center center/cover;
